...
export const PreviewScreen = forwardRef<PreviewScreenRef, Props>(
  (props, ref) => {
    ...
    if (props.mode === 'audio') {
      return (
        <div className="relative w-full flex-1 min-h-0 max-h-[1000px] bg-gray-900  overflow-hidden border-4 shadow-2xl">
    ...
    return (
      <div className="relative w-full flex-1 min-h-0 h-full bg-gray-900  overflow-hidden shadow-2xl">
        <video
          ref={videoRef}
          autoPlay
          playsInline
